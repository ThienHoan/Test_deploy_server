...
function checkTableStructure() {
    return __awaiter(this, void 0, void 0, function () {
        var pool, tableExists, columns, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!tableExists.rows[0].exists) return [3 /*break*/, 4];
                    return [4 /*yield*/, pool.query("\n        SELECT column_name, data_type, is_nullable, column_default\n        FROM information_schema.columns \n        WHERE table_name = 'users' \n        AND table_schema = 'public'\n        ORDER BY ordinal_position;\n      ")];
                case 3:
                    columns = _a.sent();
                    console.log('📊 Cấu trúc bảng hiện tại:');
                    columns.rows.forEach(function (col) {
                        console.log("  - ".concat(col.column_name, ": ").concat(col.data_type, " (nullable: ").concat(col.is_nullable, ")"));
                    });
                    // Đề xuất giải pháp
                    console.log('\n💡 Giải pháp:');
