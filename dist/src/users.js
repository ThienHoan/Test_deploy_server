...
var expressplus_1 = require("./expressplus");
...
app.get('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.query('SELECT * FROM users WHERE id = $1', [userId])];
            case 2:
                result = _b.sent();
...
app.post('/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, result, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body || {}, name = _a.name, email = _a.email;
                if (!name || !email) {
                    return [2 /*return*/, res.status(400).json({ error: 'Name and email are required' })];
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.query('INSERT INTO users (name, email) VALUES ($1, $2) RETURNING *', [name, email])];
            case 2:
                result = _b.sent();
...
app.put('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, name, email, result, error_4;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.query('UPDATE users SET name = $1, email = $2 WHERE id = $3 RETURNING *', [name, email, userId])];
            case 2:
                result = _c.sent();
                if (result.rows.length > 0) {
                    res.json(result.rows[0]);
...
app.patch('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, name, email, updates, values, paramCount, query, result, error_5;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (updates.length === 0) {
                    return [2 /*return*/, res.status(400).json({ error: 'No fields to update' })];
                }
                values.push(userId);
...
app.delete('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.query('DELETE FROM users WHERE id = $1 RETURNING *', [userId])];
            case 2:
                result = _b.sent();
                if (result.rows.length > 0) {
